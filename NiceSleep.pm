...
# $Id: NiceSleep.pm,v 1.21 2002/02/20 20:36:40 root Exp $ 
# originally generated by joshr 20020216
#############################################################################
#use 5.006;	# we assume
use 5.004;	# we're trying..
use strict;	# please
...
# these are 'public'
use vars qw ( %EXPORT_TAGS @EXPORT_OK $VERSION @ISA
	$SLEEPMODE_WALLCLOCK $SLEEPMODE_TOTALCPU $SLEEPMODE_USERCPU
	$SLEEPMODE_SYSTEMCPU); 

# these are private. We do this so we can work in old perls
...
sub get { (defined($_[0]) ? $_[0] : ""); }	# converts undefs to empty strings
...
$Log: NiceSleep.pm,v $
Revision 1.21  2002/02/20 20:36:40  root
*** empty log message ***

Revision 1.20  2002/02/20 19:33:43  test
made work with perl 5.004, wrote DumpText() so example.pl
wouldn't want to use Data::Dumper.

Revision 1.19  2002/02/20 18:28:31  root
doc touches, pre-emptive version bump to .48 (.47 is last release)

Revision 1.18  2002/02/19 22:53:28  root
release 0.47
